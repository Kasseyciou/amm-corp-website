...
const translations = Object.freeze({
  ...
  "home-services-eyebrow": "我們的服務",
  "home-services-title": "三階段專業服務",
  "home-services-button": "查看服務",
  "home-services-pre-title": "產品上市前階段",
  "home-services-pre-description": "產品註冊、制定市場進入與商業策略、識別並接洽潛在的關鍵意見領袖（KOL），以進行早期臨床評估，以及競爭者分析。",
  "home-services-launch-title": "產品上市階段",
  "home-services-launch-description": "定價策略制定、執行已制定的商業策略，以及業務銷售訓練。",
  "home-services-post-title": "產品上市後階段",
  "home-services-post-description": "收集市場趨勢與銷售活動資訊、定期監控銷售情況、依市場需求調整產品組合，並支持上市後監測。",
  "products-eyebrow": "代理產品",
  "products-title": "代理產品",
  "products-count": "代理產品",
  "products-category-one": "產品類別",
  "products-category-two": "產品類別",
  ...
  "home-product-emosist-meta": "義大利 · 第3類",
  "home-product-axiostat-meta": "印度 · 第2類",
  "home-product-tiolene-meta": "印度 · 第2類",
  "home-product-oozfix-meta": "南韓 · 第3類",
});
